/*!For license information please see 6451.ae622f95.chunk.js.LICENSE.txt*/
(self.webpackChunk_commonninja_widget_renderer = self.webpackChunk_commonninja_widget_renderer || []).push([
    [6451], {
            ...
            t.exports.o = function(t) {
                return a({
                    ...
                    child: [{
                        tag: "path",
                        attr: {
                            d: "M19,2H9C7.897,2,7,2.897,7,4v6H5c-1.103,0-2,0.897-2,2v9c0,0.552,0.447,1,1,1h8h8c0.553,0,1-0.448,1-1V4 C21,2.897,20.103,2,19,2z M5,12h3h3v2v2v4H5V12z M19,20h-6v-4v-2v-2c0-1.103-0.897-2-2-2H9V4h10V20z"
                        }
                    }, {
                        tag: "path",
                        attr: {
                            d: "M11 6H13V8H11zM15 6H17V8H15zM15 10.031H17V12H15zM15 14H17V16H15zM7 14.001H9V16.000999999999998H7z"
                        }
                    }]
                })(t)
            }
            ...
            t.exports.V = function(t) {
                return a({
                    ...
                    child: [{
                        ...
                        attr: {
                            fill: "none",
                            d: "M4.998 8H19V20H4.998z"
                        }
                    }, {
                        tag: "path",
                        attr: {
                            d: "M2.999,6v2v12c0,1.103,0.897,2,2,2h14c1.103,0,2-0.897,2-2V8V6c0-1.103-0.897-2-2-2h-2V2h-2v2h-6V2h-2v2h-2 C3.896,4,2.999,4.897,2.999,6z M19.001,20H4.999V8h14L19.001,20z"
                        }
                    }]
                })(t)
            }
            ...
            t.exports.G = function(t) {
                return a({
                    ...
                    child: [{
                        tag: "path",
                        attr: {
                            d: "M11 6H13V11H11zM11 12H13V14H11z"
                        }
                    }, {
                        tag: "path",
                        attr: {
            ...
            t.exports.Y = function(t) {
                return a({
                    ...
                    child: [{
                        tag: "path",
                        attr: {
                            d: "M12,22c5.421,0,10-4.579,10-10S17.421,2,12,2S2,6.579,2,12S6.579,22,12,22z M12,4c4.337,0,8,3.663,8,8s-3.663,8-8,8 s-8-3.663-8-8S7.663,4,12,4z"
                        }
                    }, {
                        tag: "path",
                        attr: {
                            d: "M12,17c0.901,0,2.581-0.168,3.707-1.292l-1.414-1.416C13.85,14.735,12.992,15,12,15c-1.626,0-3-1.374-3-3s1.374-3,3-3 c0.993,0,1.851,0.265,2.293,0.707l1.414-1.414C14.582,7.168,12.901,7,12,7c-2.757,0-5,2.243-5,5S9.243,17,12,17z"
                        }
                    }]
                })(t)
            }
            ...
            t.exports.s = function(t) {
                return a({
                    ...
                    child: [{
                        ...
                        tag: "path",
                        attr: {
                            d: "M13 7L11 7 11 12.414 14.293 15.707 15.707 14.293 13 11.586z"
                        }
                    }]
                })(t)
            }
            ...
            t.exports.V = function(t) {
                return a({
                    ...
                    child: [{
                        ...
                        tag: "path",
                        attr: {
                            d: "M12 0A12 12 0 1 0 12 24A12 12 0 1 0 12 0Z"
                        }
                    }]
                })(t)
            }
        ...
        54069: (t, r) => {
            "use strict";
            var c = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g,
                a = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/,
                e = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/,
                n = /\\([\u000b\u0020-\u00ff])/g,
                i = /([\\"])/g,
            ...
            function v(t) {
                ...
                if (r.length > 0 && !a.test(r)) throw new TypeError("invalid parameter value");
            ...
            r.Q = function(t) {
                ...
                var r = "object" === typeof t ? function(t) {
                    var r;
                    "function" === typeof t.getHeader ? r = t.getHeader("content-type") : "object" === typeof t.headers && (r = t.headers && t.headers["content-type"]);
                    if ("string" !== typeof r) throw new TypeError("content-type header is missing from object");
                    return r
                }(t) : t;
                if ("string" !== typeof r) throw new TypeError("argument string is required to be a string");
                var a = r.indexOf(";"),
                    e = -1 !== a ? r.slice(0, a).trim() : r.trim();
                if (!o.test(e)) throw new TypeError("invalid media type");
                var i = new h(e.toLowerCase());
                if (-1 !== a) {
                    var v, l, s;
                    for (c.lastIndex = a; l = c.exec(r);) {
                        if (l.index !== a) throw new TypeError("invalid parameter format");
                        a += l[0].length, v = l[1].toLowerCase(), 34 === (s = l[2]).charCodeAt(0) && -1 !== (s = s.slice(1, -1)).indexOf("\\") && (s = s.replace(n, "$1")), i.parameters[v] = s
                    }
                    if (a !== r.length) throw new TypeError("invalid parameter format")
                }
                return i
            }
        },
        81452: (t, r, c) => {
            ...
            function n() {}
            n.resetWarningCache = e, t.exports = function() {
                function t(t, r, c, e, n, i) {
                    if (i !== a) {
            ...
            var a = c(66017),
                ...
                s = function(t, r, c) {
                    ...
                    a.onreadystatechange = function() {
                        try {
                            if (!/\.svg/i.test(t) && 2 === a.readyState) {
                                var r = a.getResponseHeader("Content-Type");
                                if (!r) throw new Error("Content type not found");
                                var e = (0, o.Q)(r).type;
                                if ("image/svg+xml" !== e && "text/plain" !== e) throw new Error("Invalid content type: ".concat(e))
                            }
                            if (4 === a.readyState) {
                                if (404 === a.status || null === a.responseXML) throw new Error(l() ? "Note: SVG injection ajax calls do not work locally without adjusting security settings in your browser. Or consider using a local webserver." : "Unable to load SVG file: " + t);
                                if (!(200 === a.status || l() && 0 === a.status)) throw new Error("There was a problem injecting the SVG: " + a.status + " " + a.statusText);
                                c(null, a)
                            }
                        } catch (n) {
                            if (a.abort(), !(n instanceof Error)) throw n;
                            c(n, a)
                        }
                    }, a.open("GET", t), a.withCredentials = r, a.overrideMimeType && a.overrideMimeType("text/xml"), a.send()
                },
                u = {},
                g = function(t, r) {
                    u[t] = u[t] || [], u[t].push(r)
                ...
                d = function(t, r, c) {
                    if (v.has(t)) {
                        var a = v.get(t);
                        if (void 0 === a) return void g(t, c);
                        if (a instanceof SVGSVGElement) return void c(null, h(a))
                    }
                    v.set(t, void 0), g(t, c), s(t, r, (function(r, c) {
                        var a;
                        r ? v.set(t, r) : (null === (a = c.responseXML) || void 0 === a ? void 0 : a.documentElement) instanceof SVGSVGElement && v.set(t, c.responseXML.documentElement),
                            function(t) {
                                for (var r = function(r, c) {
                                        setTimeout((function() {
                                            if (Array.isArray(u[t])) {
                                                var c = v.get(t),
                                                    a = u[t][r];
                                                c instanceof SVGSVGElement && a(null, h(c)), c instanceof Error && a(c), r === u[t].length - 1 && delete u[t]
                                            }
                                        }), 0)
                                    }, c = 0, a = u[t].length; c < a; c++) r(c)
                            }(t)
                    }))
                },
                p = function(t, r, c) {
                    s(t, r, (function(t, r) {
                        var a;
                        t ? c(t) : (null === (a = r.responseXML) || void 0 === a ? void 0 : a.documentElement) instanceof SVGSVGElement && c(null, r.responseXML.documentElement)
                    }))
                },
                z = 0,
                f = [],
                ...
                M = function(t, r, c, a, e, n, o) {
                    var v = t.getAttribute("data-src") || t.getAttribute("src");
                    if (v) {
                        if (-1 !== f.indexOf(t)) return f.splice(f.indexOf(t), 1), void(t = null);
                        f.push(t), t.setAttribute("src", ""), (a ? d : p)(v, e, (function(a, e) {
                            if (!e) return f.splice(f.indexOf(t), 1), t = null, void o(a);
                            var h = t.getAttribute("id");
                            h && e.setAttribute("id", h);
                            var l = t.getAttribute("title");
                            l && e.setAttribute("title", l);
                            var s = t.getAttribute("width");
                            s && e.setAttribute("width", s);
                            var u = t.getAttribute("height");
                            u && e.setAttribute("height", u);
                            var g = Array.from(new Set((0, i.ev)((0, i.ev)((0, i.ev)([], (e.getAttribute("class") || "").split(" "), !0), ["injected-svg"], !1), (t.getAttribute("class") || "").split(" "), !0))).join(" ").trim();
                            e.setAttribute("class", g);
                            var d = t.getAttribute("style");
                            d && e.setAttribute("style", d), e.setAttribute("data-src", v);
                            ...
                            if (Array.prototype.forEach.call(p, (function(t) {
                                ...
                                Object.keys(L).forEach((function(t) {
                                    ...
                                    for (var r = function(t, r) {
                                            var c;
                                            H = m[t].id, V = H + "-" + ++z, Array.prototype.forEach.call(C, (function(t) {
                                                for (var r = 0, a = (c = e.querySelectorAll("[" + t + '*="' + H + '"]')).length; r < a; r++) {
                                                    var n = c[r].getAttribute(t);
                                                    n && !n.match(new RegExp('url\\("?#' + H + '"?\\)')) || c[r].setAttribute(t, "url(#" + V + ")")
                                                }
                                            }));
                                            for (var a = e.querySelectorAll("[*|href]"), n = [], i = 0, o = a.length; i < o; i++) {
                                                var v = a[i].getAttributeNS(x, "href");
                                                v && v.toString() === "#" + m[t].id && n.push(a[i])
                                            }
                                            for (var h = 0, l = n.length; h < l; h++) n[h].setAttributeNS(x, "href", "#" + V);
                                            m[t].id = V
                                        }, c = 0, a = (m = e.querySelectorAll(M + "[id]")).length; c < a; c++) r(c)
                                }))
                            }
                            e.removeAttribute("xmlns:a");
                            for (var _, B, y = e.querySelectorAll("script"), S = [], A = 0, b = y.length; A < b; A++)(B = y[A].getAttribute("type")) && "application/ecmascript" !== B && "application/javascript" !== B && "text/javascript" !== B || ((_ = y[A].innerText || y[A].textContent) && S.push(_), e.removeChild(y[A]));
                            if (S.length > 0 && ("always" === r || "once" === r && !w[v])) {
                                for (var k = 0, E = S.length; k < E; k++) new Function(S[k])(window);
                                w[v] = !0
                            }
                            var R = e.querySelectorAll("style");
                            if (Array.prototype.forEach.call(R, (function(t) {
                                    t.textContent += ""
                                })), e.setAttribute("xmlns", "http://www.w3.org/2000/svg"), e.setAttribute("xmlns:xlink", x), n(e), !t.parentNode) return f.splice(f.indexOf(t), 1), t = null, void o(new Error("Parent node is null"));
                            t.parentNode.replaceChild(e, t), f.splice(f.indexOf(t), 1), t = null, o(null, e)
                        }))
                    } else o(new Error("Invalid data-src or src attribute"))
                },
                m = c(63090),
                C = c(53617),
                H = ["afterInjection", "beforeInjection", "desc", "evalScripts", "fallback", "httpRequestWithCredentials", "loading", "renumerateIRIElements", "src", "title", "useRequestCache", "wrapper"],
                V = "http://www.w3.org/2000/svg",
                L = "http://www.w3.org/1999/xlink",
                _ = function(t) {
                    function r() {
                        for (var r, c = arguments.length, a = new Array(c), e = 0; e < c; e++) a[e] = arguments[e];
                        return (r = t.call.apply(t, [this].concat(a)) || this).initialState = {
                            hasError: !1,
                            isLoading: !0
                        }, r.state = r.initialState, r._isMounted = !1, r.reactWrapper = void 0, r.nonReactWrapper = void 0, r.refCallback = function(t) {
                            r.reactWrapper = t
                        }, r
                    }(0, n.Z)(r, t);
                    var c = r.prototype;
                    return c.renderSVG = function() {
                        var t, r = this;
                        if (this.reactWrapper instanceof(t = this.reactWrapper, ((null == t ? void 0 : t.ownerDocument) || document).defaultView || window).Node) {
                            var c, a, e = this.props,
                                n = e.desc,
                                i = e.evalScripts,
                                o = e.httpRequestWithCredentials,
                                v = e.renumerateIRIElements,
                                h = e.src,
                                l = e.title,
                                s = e.useRequestCache,
                                u = this.props.onError,
                                g = this.props.beforeInjection,
                                d = this.props.afterInjection,
                                p = this.props.wrapper;
                            "svg" === p ? ((c = document.createElementNS(V, p)).setAttribute("xmlns", V), c.setAttribute("xmlns:xlink", L), a = document.createElementNS(V, p)) : (c = document.createElement(p), a = document.createElement(p)), c.appendChild(a), a.dataset.src = h, this.nonReactWrapper = this.reactWrapper.appendChild(c);
                            var z = function(t) {
                                r.removeSVG(), r._isMounted ? r.setState((function() {
                                    return {
                                        hasError: !0,
                                        isLoading: !1
                                    }
                            ...
                            ! function(t, r) {
                                var c = void 0 === r ? {} : r,
                                    ...
                                    s = c.evalScripts,
                                    u = void 0 === s ? "never" : s,
                                    g = c.httpRequestWithCredentials,
                                    d = void 0 !== g && g,
                                    p = c.renumerateIRIElements,
                                    z = void 0 === p || p;
                                if (t && "length" in t)
                                    for (var f = 0, w = 0, x = t.length; w < x; w++) M(t[w], u, z, l, d, v, (function(r, c) {
                                        i(r, c), t && "length" in t && t.length === ++f && e(f)
                                    }));
                                else t ? M(t, u, z, l, d, v, (function(r, c) {
                                    i(r, c), e(1), t = null
                                })) : e(0)
                            }(a, {
                                afterEach: function(t, c) {
                                    t ? z(t) : r._isMounted && r.setState((function() {
                                        return {
                                            isLoading: !1
                                        }
                                    }), (function() {
                                ...
                                beforeEach: function(t) {
                                    if (t.setAttribute("role", "img"), n) {
                                        var r = t.querySelector(":scope > desc");
                                        r && t.removeChild(r);
                                        var c = document.createElement("desc");
                                        c.innerHTML = n, t.prepend(c)
                                    }
                                    if (l) {
                                        var a = t.querySelector(":scope > title");
                                        a && t.removeChild(a);
                                        var e = document.createElement("title");
                                        e.innerHTML = l, t.prepend(e)
                                    }
                                    try {
                                        g(t)
                                    } catch (i) {
                                ...
                                cacheRequests: s,
                                evalScripts: i,
                                httpRequestWithCredentials: o,
                                renumerateIRIElements: v
                            })
                        }
                    }, c.removeSVG = function() {
                        var t;
                        ...
                        (function(t, r) {
                            ...
                            for (var a in r)
                                if (t[a] !== r[a]) return !0;
                            return !1
                        })((0, e.Z)({}, t), this.props) && this.setState((function() {
                            return r.initialState
                        }), (function() {
                            r.removeSVG(), r.renderSVG()
                        }))
                    }, c.componentWillUnmount = function() {
                        this._isMounted = !1, this.removeSVG()
                    }, c.render = function() {
                        var t = this.props;
                        t.afterInjection, t.beforeInjection, t.desc, t.evalScripts;
                        var r = t.fallback;
                        t.httpRequestWithCredentials;
                        var c = t.loading;
                        t.renumerateIRIElements, t.src, t.title, t.useRequestCache;
                        var n = t.wrapper,
                            i = (0, a.Z)(t, H),
                            o = n;
                        return C.createElement(o, (0, e.Z)({}, i, {
                            ref: this.refCallback
                        }, "svg" === n ? {
                            xmlns: V,
                            xmlnsXlink: L
                        } : {}), this.state.isLoading && c && C.createElement(c, null), this.state.hasError && r && C.createElement(r, null))
                    }, r
                }(C.Component);
            _.defaultProps = {
                ...
                afterInjection: m.func,
                beforeInjection: m.func,
                desc: m.string,
                evalScripts: m.oneOf(["always", "once", "never"]),
                fallback: m.oneOfType([m.func, m.object, m.string]),
                httpRequestWithCredentials: m.bool,
                loading: m.oneOfType([m.func, m.object, m.string]),
                onError: m.func,
                renumerateIRIElements: m.bool,
                src: m.string.isRequired,
                title: m.string,
                useRequestCache: m.bool,
                wrapper: m.oneOf(["div", "span", "svg"])
            }
        },
        23788: (t, r, c) => {
            "use strict";
            ...
            function e(t, r) {
                t.prototype = Object.create(r.prototype), t.prototype.constructor = t, (0, a.Z)(t, r)
            }
        },
        66017: (t, r, c) => {
            "use strict";
            ...
            function a(t, r) {
                ...
                var c, a, e = {},
                    n = Object.keys(t);
                for (a = 0; a < n.length; a++) c = n[a], r.indexOf(c) >= 0 || (e[c] = t[c]);
                return e
            }
            c.d(r, {
                Z: () => a
